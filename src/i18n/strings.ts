...
export const STRINGS: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    "menu.kicker.light": "// hora do dia",
    "time.night.label": "Noite",
    "time.night.hint": "Dois postes, e a tinta neon acende o muro",
    "time.day.label": "Dia",
    "time.day.hint": "Céu encoberto, luz pareja nos dois muros, neon quase sumido",
    "wall.city": "Cidade",
    "wall.place": "Local",
    "wall.city.default": "Padrão",
    "wall.side.left": "Muro da esquerda",
    "wall.side.right": "Muro da direita",
    "wall.photo.remove": "Tirar",
    "wall.photo.tile": "Tamanho do bloco da foto",
    "wall.drop": "Arraste uma imagem para um muro e ela cobre aquele muro. A imagem fica só no seu computador.",
  ...
  en: {
    ...
    "menu.kicker.light": "// time of day",
    "time.night.label": "Night",
    "time.night.hint": "Two lamps, and neon paint lights the wall itself",
    "time.day.label": "Day",
    "time.day.hint": "Overcast, both walls lit evenly, neon almost gone",
    "wall.city": "City",
    "wall.place": "Place",
    "wall.city.default": "Default",
    "wall.side.left": "Left wall",
    "wall.side.right": "Right wall",
    "wall.photo.remove": "Remove",
    "wall.photo.tile": "Tile size of the photo",
    "wall.drop": "Drag an image onto a wall and it covers that wall. The image stays on your computer.",
