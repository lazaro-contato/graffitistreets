...
export const STRINGS: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    "cap.skinny.label": "Fininho",
    "cap.skinny.hint": "Traço limpo e estreito. É a ponta do contorno e da assinatura",
    "cap.circle.label": "Redondo",
    "cap.circle.hint": "O cap do dia a dia. Serve pra quase tudo e perdoa mão tremida",
    "cap.fat.label": "Fat cap",
    "cap.fat.hint": "Cobre rápido. É com ela que se preenche o miolo das letras",
    "cap.super.label": "Super fat",
    "cap.super.hint": "Máxima cobertura, mínimo controle. Nuvem larga pra fundo",
    "cap.mist.label": "Névoa",
    "cap.mist.hint": "Lisa, sem grão. A ponta do esfumado e da passagem de cor",
  ...
  en: {
    ...
    "cap.circle.hint": "The everyday cap. Good for almost anything, forgives a shaky hand",
    "cap.fat.label": "Fat cap",
    "cap.fat.hint": "Covers fast. This is what fills the middle of a letter",
    "cap.super.label": "Super fat",
    "cap.super.hint": "Maximum coverage, minimum control. A wide cloud for backgrounds",
    "cap.mist.label": "Mist",
    "cap.mist.hint": "Smooth, no grain. The tip for fades and blending one colour into another",
